...
CREATE INDEX IF NOT EXISTS idx_regulation_updates_active ON regulation_updates(is_active);

-- Add unique constraint for alerts to prevent duplicates
CREATE UNIQUE INDEX IF NOT EXISTS idx_alerts_unique ON alerts(complex_id, alert_type, title) WHERE complex_id IS NOT NULL;
